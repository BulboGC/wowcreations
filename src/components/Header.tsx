...
export default function Header() {
  return (
    <div className={`${covers.relativeDiv}`} id="#">
      <div
        className={`${covers.absoluteBack} ${covers.topLeft} filter2`}
        style={{ display: "flex" }}
      />

      <div
        className={`${covers.absoluteBack} ${covers.topRight} filter2`}
        style={{ display: "flex" }}
      />
      ...
      <div className={`${covers.divHeader} flex flex-col text-focus-in`}>
        ...
        <div className="md:hidden sm:block flex flex-col ml-3">
